...
@app.route('/')
def home():
    return render_template('flindex.html')

# Contact page
@app.route('/contact')
def contact():
    return render_template('flcontact.html')
...
def prediction():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            predicted_item = "Rose"  # Placeholder predicted item
...
if __name__ == "__main__":
    app.run(host="127.0.0.1", port=8101, debug=True, use_reloader=False)
